...
class UIFascilities: NSObject {
    ...
    class func setAutoLayoutConstraints(subview: UIView?, superview: UIView?, margin: (top: CGFloat, right: CGFloat, bottom: CGFloat, left: CGFloat)) {
    ...
    class func setAutoLayoutConstraints(subview: UIView?, superview: UIView?) {
        self.setAutoLayoutConstraints(subview: subview, superview: superview, margin: (0, 0, 0, 0))
    }
    ...
    enum MessageBubbleCaretPosition {
        case undefined, top, bottom, left, right
    }
    
    enum UIFascilitiesLayoutStyle {
        case horizontal, vertical
        case noborder, bordered
    }
    
    class func createActionsView(captions: Array<String>, backgroundColor: UIColor?, textColor: UIColor?, font: UIFont?, h_margin: CGFloat, v_margin: CGFloat, styles: Array<UIFascilitiesLayoutStyle>) -> (UIView?, Array<UIView>) {
        ...
        var spreadStyle: UIFascilitiesLayoutStyle = .horizontal
